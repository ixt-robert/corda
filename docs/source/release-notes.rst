...
Transactions created under a Corda 4+ node will have the currently valid signed ``NetworkParameter``
...
now RPC wire compatible and either client library can be used.
